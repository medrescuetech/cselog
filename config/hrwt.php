...
return [
    ...
    'amber_hours' => (float) env('HRWT_AMBER_HOURS', 2),
    'red_hours' => (float) env('HRWT_RED_HOURS', 4),

    // Standalone map package (see sitemap/README.md). Served at /sitemap via public/sitemap symlink.
    'sitemap_path' => env('HRWT_SITEMAP_PATH', base_path('sitemap')),
    'sitemap_url' => env('HRWT_SITEMAP_URL', '/sitemap'),
